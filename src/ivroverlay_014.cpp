...
class proxy_IVROverlay_014 : public clone_IVROverlay_014
{
public:
...
IVROverlay* getIVROverlayProxy_014()
{
	return (IVROverlay*) new proxy_IVROverlay_014();
}
