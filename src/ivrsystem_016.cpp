...
class proxy_IVRSystem_016 : public clone_IVRSystem_016
{
public:
	...
	{
		fns_IVRSystem::GetOutputDevice(pnDevice, textureType);
		return;
	}
...
IVRSystem* getIVRSystemProxy_016 ()
{
	// XXX: Do we need error checking?
	return (IVRSystem*) new proxy_IVRSystem_016;
};
